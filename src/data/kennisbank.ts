...
export const kennisbankCategorieen: KennisbankCategorie[] = [
  ...
  },
  {
    ...
    modules: [
      {
        id: "cyclus",
        titel: "Cyclus en eten (per fase)",
        klikbaar: true,
        pad: "/kennisbank/hormonen-en-organen/cyclus",
      },
      {
        id: "lever",
        titel: "De lever, het orgaan dat alles draagt",
        klikbaar: false,
        pad: "/kennisbank/hormonen-en-organen/lever",
      },
      {
        id: "darmwand",
        titel: "Darmwandherstel: waarom je je in het begin niet meteen beter voelt",
        klikbaar: false,
        pad: "/kennisbank/hormonen-en-organen/darmwand",
      },
    ],
  },
  {
