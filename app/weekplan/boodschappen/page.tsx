      ...
      <div className="mx-auto w-full max-w-3xl">
        <div className="rounded-2xl border border-stone-200 bg-white p-10 shadow-sm">
          ...
          <p className="mt-2 text-sm text-stone-600">
            Weekboodschappen: vink aan wat je al in huis hebt. Onder «Altijd op
            voorraad» staat wat je (eenmalig) goed op voorraad kunt zetten voor
            snelle maaltijden. De lijst hoort bij je meest recente weekplan, tenzij
            je een specifiek plan kiest via de weekpagina.
          </p>
